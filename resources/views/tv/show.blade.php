{{-- logic nya sudah di pindahkan ke dalam file MovieViewModel --}}
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row ">
            ...
            <div class="md:ml-24">
               ...
               <div class="flex flex-wrap items-center text-gray-400 tex-sm">
                    ...
                    <span class="mx-2">|</span>
                    {{-- <span class="mx-2">{{ $tvshow['production_companies'] }}</span> --}}
                    <span>
                      {{ $tvshow['genres'] }}
                    </span>
                                        ...
                                        <div class="bg-gray-900 rounded">
                                            ...
                                            <div class="modal-body px-8 py-8">
                                                <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                                    ...
                                                    src="https://www.youtube.com/embed/{{ $tvshow['videos']['results'][0]['key'] }}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
