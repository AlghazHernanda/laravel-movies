...
class ActorViewModel extends ViewModel
{
    ...
    public function knownForMovies()
    {
        ...
        //ambil cast movie dan media_type, urutkan dari yang paling popular, ambil 5 aja
        return collect($castMovies)->sortByDesc('popular')->take(5)->map(function ($movie) { // map (movie) adalah mengambil satu satu dari castmovies
    ...
    public function credits()
    {
        ...
        return collect($castMovies)->map(function ($movie) {
            ...
            //ini pengecekan jika ada movie title maka masukan ke variabel $title, jika adanya movie name
            // maka masukan ketitle
            if (isset($movie['title'])) {
                $title = $movie['title'];
            } elseif (isset($movie['name'])) {
                $title = $movie['name'];
